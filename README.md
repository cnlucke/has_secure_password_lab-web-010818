...
Our app has three pages:
  1. A signup page, where the user enters their name, password, and password confirmation.
  2. A login page, where the user submits their name and password and are logged in.
